...
int main(){
    ...
    cout<<x+y<<endl;
    cout<<x*y<<endl;
    cout<<x/y<<endl; // consider number which is before decimal
    cout<<"size of x: "<<sizeof(x)<<endl; // sizeof gives size of variable in bytes
    cout<<"size of y: "<<sizeof(y)<<endl; // sizeof gives size of variable in bytes
    
    
    signed int z {5};
    cout<<"sizeof z: "<<sizeof(z)<<endl; // sizeof gives size of variable in
    

    unsigned int w {5}; // unsigned int cannot hold negative values, so it will wrap around
    cout<<"sizeof w: "<<sizeof(w)<<endl; // sizeof gives size of variable in
    ...
    short int short_int {455} ; // short and short int are same
    ...
    long int long_int {33}; // long and long int are same
    signed long signed_long {44};
    signed long int signed_long_int {44};
    unsigned long int unsigned_long_int{44};

    long long long_long {888};// 8 Bytes
    long long int long_long_int {999}; // long long and long long int are same
